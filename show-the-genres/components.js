...
new (class extends _identity {
	...
	static {
		class _GenreLink extends (_LitElement = LitElement) {
			static {
				({
					e: [_init_genre, _initProto],
					c: [__GenreLink, _initClass],
				} = _apply_decs_2203_r(this, [[_dec1, 1, "genre"]], [_dec], _LitElement));
			}
			static styles = css`
        :host > a {
...
(_dec2 = customElement("genre-container")),
	(_dec3 = property()),
	(_dec4 = property()),
	(_dec5 = state()),
	(_dec6 = property({
...
class _ArtistGenreContainer extends (_LitElement1 = LitElement) {
	static {
		({
			e: [_init_name, _init_uri, _init_genres, _init_isSmall, _init_fetchGenres, _initProto1],
			c: [__ArtistGenreContainer, _initClass1],
		} = _apply_decs_2203_r(
			this,
			[
				[_dec3, 1, "name"],
