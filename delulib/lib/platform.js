...
export const setInLibrary = (uris, liked) =>
	LibraryAPI[liked ? "add" : "remove"]({
		uris,
	});
...
export const fetchArtistLikedTracks = async (uri, offset = 0, limit = 100) =>
	(
		await LibraryAPI.getTracks({
			uri,
			offset,
...
/* Replaced by createPlaylistFromTracks */ export const createPlaylist = async (name, location = {}) =>
...
export const fetchFolder = async folder =>
	await RootlistAPI.getContents({
		folderUri: folder,
	});
