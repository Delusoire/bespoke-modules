...
const { forwardRef, memo, useRef, useState } = React
import { Editor, Text, Path, Element, Node } from 'https://esm.sh/slate'

import { ReactEditor, useSlateStatic } from '../index.ts'
...
import { MARK_PLACEHOLDER_SYMBOL } from '../utils/weak-maps.ts'
