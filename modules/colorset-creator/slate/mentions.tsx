...
const MentionExample = () => {
	...
	const renderElement = useCallback((props: SlateReact.RenderElementProps) => <Element {...props} />, []);
	const renderLeaf = useCallback((props: SlateReact.RenderLeafProps) => <Leaf {...props} />, []);
...
const Leaf = ({ attributes, children, leaf }: SlateReact.RenderLeafProps) => {
	// @ts-ignore
	if (leaf.bold) {
...
const Mention = ({ attributes, children, element }: RenderCustomElementProps<MentionElement>) => {
