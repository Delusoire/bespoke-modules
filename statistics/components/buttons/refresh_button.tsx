...
const RefreshButton = ({ refresh }: RefreshButtonProps): React.ReactElement<HTMLButtonElement> => (
	<S.ReactComponents.Tooltip label={"Refresh"} renderInline={true} placement="top">
		<S.ReactComponents.UI.ButtonTertiary buttonSize="sm" onClick={refresh} aria-label="Refresh" iconOnly={RefreshIcon} />
