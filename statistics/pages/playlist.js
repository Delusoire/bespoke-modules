...
const PlaylistPage = ({ uri })=>{
    ...
    const statCards = Object.entries(audioFeatures).map(([key, value])=>/*#__PURE__*/ React.createElement(StatCard, {
            label: key,
            value: value
        }));
    const artistCards = artists.map((artist)=>/*#__PURE__*/ React.createElement(SpotifyCard, {
            type: "artist",
            uri: artist.uri,
            header: artist.name,
    ...
    const albumCards = albums.map((album)=>/*#__PURE__*/ React.createElement(SpotifyCard, {
            type: "album",
            uri: album.uri,
            header: album.name,
