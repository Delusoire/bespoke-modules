...
const wrapDropdownInsidePlaylistButton = (pb, uri, forced = false)=>{
    ...
    ReactDOM.render(/*#__PURE__*/ S.React.createElement(Dropdown, {
        uri: uri
    }), div);
...
export const updateTrackListControls = (updateDropdown = true)=>getTrackLists().map(getTrackListTracks).map(fp.map((track)=>{
