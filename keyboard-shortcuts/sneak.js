...
new (class extends _identity {
	...
	static {
		class _SneakKey extends (_LitElement = LitElement) {
			static {
				({
					e: [_init_key, _init_target, _initProto],
					c: [__SneakKey, _initClass],
				} = _apply_decs_2203_r(
					this,
					[
						[_dec1, 1, "key"],
...
let __SneakOverlay;
(_dec3 = customElement("sneak-overlay")),
	(_dec4 = property({
		type: Array,
	}));
new (class extends _identity {
	...
	static {
		class _SneakOverlay extends (_LitElement1 = LitElement) {
			static {
				({
					e: [_init_props, _initProto1],
					c: [__SneakOverlay, _initClass1],
				} = _apply_decs_2203_r(this, [[_dec4, 1, "props"]], [_dec3], _LitElement1));
			}
			static styles = css`
        :host {
            z-index: 1e5;
