import { createEventBus } from "/modules/stdlib/mod.js";
...
function galaxyFade() {
    ...
    waitForElement([
        ".jEMA2gVoLgPQqAFrPhFw [data-overlayscrollbars-viewport]"
    ], ([scrollNode])=>{
    ...
    waitForElement([
        ".BdcvqBAid96FaHAmPYw_ [data-overlayscrollbars-viewport]"
    ], ([scrollNode])=>{
