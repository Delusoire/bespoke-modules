...
import { parseWebAPITrack } from "/modules/Delusoire.delulib/lib/parse.js";
import { getTracksFromAlbum } from "./fetch.js";
import { CONFIG } from "./settings.js";
import { SortAction, SortActionProp, joinByUri } from "./util.js";
import { fromString } from "/modules/stdlib/src/webpack/URI.js";
...
export const fillTracksFromSpotify = (propName)=>async (tracks)=>{
        ...
        const tracksPopulater = _.cond([
            [
                fp.startsWith(SortAction.SPOTIFY_PLAYCOUNT),
                ()=>fillTracksFromAlbumTracks
            ],
            [
                _.stubTrue,
                ()=>fillTracksFromWebAPI
            ]
        ])(propName);
