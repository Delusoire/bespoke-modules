import { createRegistrar } from "/modules/stdlib/mod.js";
import { createSettings } from "/modules/stdlib/lib/settings.js";
import { TopbarLeftButton } from "/modules/stdlib/src/registers/topbarLeftButton.js";
import { React } from "/modules/stdlib/src/expose/React.js";
export let settings;
export default async function(mod) {
    ...
    registrar.register("menu", /*#__PURE__*/ React.createElement(SortBySubMenu, null));
    registrar.register("topbarLeftButton", /*#__PURE__*/ React.createElement(TopbarLeftButton, {
