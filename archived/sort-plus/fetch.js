import { fetchAlbumTracks } from "/modules/Delusoire.delulib/lib/GraphQL/fetchAlbumTracks.js";
...
import { _, fp } from "/modules/stdlib/deps.js";
...
import { is } from "/modules/stdlib/src/webpack/URI.js";
...
export const getTracksFromPlaylist = _.flow(fetchPlaylistContents, pMchain(fp.map(catchOrEmpty(parsePlaylistAPITrack, {
    uri: null
}))), pMchain(fp.filter((track)=>is.Track(track.uri) && !is.LocalTrack(track.uri))));
