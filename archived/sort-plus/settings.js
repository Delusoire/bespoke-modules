...
export const CONFIG = settings.addToggle({
    ...
    id: "artistPopularReleases",
    desc: "Popular Releases"
}, ()=>true).addToggle({
    id: "artistSingles",
    desc: "Singles"
}).addToggle({
    ...
    id: "artistCompilations",
    desc: "Compilations"
}).addToggle({
    id: "artistLikedTracks",
    desc: "Liked Tracks"
}, ()=>true).addToggle({
    id: "artistAppearsOn",
    desc: "Appears On"
    ...
    inputType: "text"
}, async ()=>(await createFolder(SORTED_PLAYLISTS_FOLDER_NAME)).uri).finalize().cfg;
