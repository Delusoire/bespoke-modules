...
const vertShader = await fetch("/modules/Delusoire/better-lyrics/src/core/bg-render/shaders/base.vert.glsl")
	.then((res) => res.text());
const fragShader = await fetch("/modules/Delusoire/better-lyrics/src/core/bg-render/shaders/base.frag.glsl")
	.then((res) => res.text());
const blendShader = await fetch("/modules/Delusoire/better-lyrics/src/core/bg-render/shaders/blend.frag.glsl")
	.then((res) => res.text());
const eplorShader = await fetch("/modules/Delusoire/better-lyrics/src/core/bg-render/shaders/eplor.frag.glsl")
	.then((res) => res.text());
const noiseShader = await fetch("/modules/Delusoire/better-lyrics/src/core/bg-render/shaders/noise.frag.glsl")
	.then((res) => res.text());
