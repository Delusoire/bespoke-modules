...
class CatmullRomCurve {
    ...
    static fromPointsAndAlpha(P, alpha) {
        const T = zip_n_uplets(2)(P).map(([Pi, Pj])=>vectorDist(Pi, Pj) ** alpha).map((ki, i, kis)=>(i > 0 ? kis[i - 1] : 0) + ki);
    ...
    at(t) {
        ...
        return vectorLerpWithRemapedScalar([
            this.T[1],
            B[0]
        ], [
            this.T[2],
...
export class AlphaCatmullRomSpline {
    ...
    static fromPointsClamped(points, alpha = 0.5) {
        ...
        return AlphaCatmullRomSpline.fromPoints([
            P0,
            ...points,
            P5
        ], alpha);
...
export class CatmullRomSpline {
    ...
    static fromPointsClamped(points) {
        ...
        const [P3, P4] = _.takeRight(points, 2);
        const P0 = [
            scalarLerp(P1[0], P2[0], -1),
            vectorLerp(P1[1], P2[1], -1)
        ];
        const P5 = [
            scalarLerp(P3[0], P4[0], 2),
            vectorLerp(P3[1], P4[1], 2)
        ];
        return CatmullRomSpline.fromPoints([
            P0,
            ...points,
            P5
        ]);
