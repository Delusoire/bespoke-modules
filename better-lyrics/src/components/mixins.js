...
export const SyncedMixin = superClass => {
	...
	class mixedClass extends superClass {
		static {
			({
				e: [_init_content, _init_tsp, _init_tep, _initProto],
			} = _apply_decs_2203_r(
				this,
				[
					[_dec, 1, "content"],
...
export const ScrolledMixin = superClass => {
	...
	class mixedClass extends superClass {
		static {
			({
				e: [_init_scrollTimeout, _init_scrollContainer],
			} = _apply_decs_2203_r(
				this,
				[
					[_dec, 0, "scrollTimeout"],
					[_dec1, 0, "scrollContainer"],
				],
				[],
			));
		}
...
export const SyncedContainerMixin = superClass => {
	...
	class mixedClass extends superClass {
		static {
			({
				e: [_init_childs, _initProto],
			} = _apply_decs_2203_r(this, [[_dec, 1, "childs"]], []));
		}
