...
import { SEPARATOR_URI, SortAction, SortActionIcon, SortActionProp, URI_is_LikedTracks } from "./util.js";
...
const setQueue = tracks => {
	if (PlayerAPI._state.item?.uid == null)
		return void S.Snackbar.enqueueSnackbar("Queue is null!", {
			variant: "error",
		});
	...
	const queue = globalThis.lastSortedQueue
		.concat({
			uri: SEPARATOR_URI,
		})
	...
	return /*#__PURE__*/ S.React.createElement(
		S.ReactComponents.MenuItem,
		{
			...
			leadingIcon: createIconComponent({
				icon: SVGIcons[SortActionIcon[sortAction]],
			}),
		},
		sortAction,
	);
	...
	return /*#__PURE__*/ S.React.createElement(
		S.ReactComponents.MenuItem,
		{
			...
			onClick: () =>
				sortTracksBy(
					"Stars",
					fp.sortBy(track => globalThis.tracksRatings[track.uri] ?? 0),
					descending,
				)(uri),
			leadingIcon: createIconComponent({
				icon: SVGIcons["heart-active"],
			}),
		},
		"Stars",
	);
...
export const SortBySubMenu = () => {
	...
	const leadingIcon = createIconComponent({
		icon: SVGIcons[descending ? "chart-down" : "chart-up"],
	});
	return /*#__PURE__*/ S.React.createElement(
		...
		SubMenuItems.map(SubMenuItem =>
			/*#__PURE__*/ S.React.createElement(SubMenuItem, {
